...
<?php if (is_front_page()) : ?>
	<header id="site-header" role="banner" class="bg-white py-12 bg-fixed flex items-center bg-cover bg-center bg-no-repeat" <?php foundry_header_styles(); ?>>
		<div class="wrapper w-full flex items-center md:space-x-3">
			<?php
